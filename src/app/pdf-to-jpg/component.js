        ...
        <main>
            <div className="flex flex-col justify-center items-center min-h-screen">
                ...
                <Card className="card flex flex-col justify-center items-center shadow-md">
                    <CardHeader>
                        <CardTitle className="text-center text-xl font-normal">PDF to JPG Converter</CardTitle>
                        <CardDescription className="font-light">Convert PDF pages to JPG</CardDescription>
                    </CardHeader>
