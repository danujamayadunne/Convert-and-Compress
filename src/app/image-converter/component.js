        ...
        <main>
            <div className="flex flex-col justify-center items-center min-h-screen">
                ...
                <Card className="card flex flex-col justify-center items-center shadow-md">
                    <CardHeader>
                        <CardTitle className="text-center text-xl font-normal">Convert Image</CardTitle>
                        <CardDescription className="text-center font-light">Convert images to modern formats</CardDescription>
                    </CardHeader>
                    <CardContent className="flex flex-col justify-center items-center gap-5">
                        ...
                        {isConverted && (
                            <Button className="rounded-sm text-white font-light" onClick={handleDownload}>
