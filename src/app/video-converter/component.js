        ...
        <main>
            <div className="flex flex-col justify-center items-center min-h-screen p-4">
                ...
                <Card className="card flex flex-col justify-center items-center shadow-md max-w-2xl">
                    <CardHeader>
                        <CardTitle className="text-center text-xl font-normal">Convert Video</CardTitle>
                        <CardDescription className="text-center font-light">Convert videos to modern formats</CardDescription>
                    </CardHeader>
                    <CardContent className="flex flex-col justify-center items-center gap-5">
                        {!videoSrc && (
                            <Button variant="secondary" className="rounded-full font-normal">
                                <input
                                    type="file"
                                    accept="video/*"
                                    id="input"
                                ...
                                />
                                <label htmlFor="input" className="cursor-pointer font-normal">Select Video</label>
                            </Button>
                        )}
