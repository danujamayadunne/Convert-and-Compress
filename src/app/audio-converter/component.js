        ...
        <main>
            <div className="flex flex-col justify-center items-center min-h-screen">
                ...
                <Card className="card flex flex-col justify-center items-center shadow-md">
                    <CardHeader>
                        <CardTitle className="text-center text-xl font-normal">Convert Audio</CardTitle>
                        <CardDescription className='font-light'>Convert audio files to modern formats</CardDescription>
                    </CardHeader>
